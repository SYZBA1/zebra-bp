        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-2xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
                {/* Feasibility Study */}
                <button
                  onClick={() => { setDocumentType("feasibility"); setView("setup"); }}
                ...
                {/* Business Plan */}
                <button
                  onClick={() => { setDocumentType("business-plan"); setView("setup"); }}
                  className="border border-border rounded-lg p-5 hover:bg-secondary transition-colors group text-left"
                >
                  <p className="font-display font-bold text-base mb-1 group-hover:text-primary transition-colors">
                ...
                <button
                  onClick={() => { setDocumentType("strategic-business"); setView("setup"); }}
                  className="border border-border rounded-lg p-5 hover:bg-secondary transition-colors group text-left"
                >
                  <p className="font-display font-bold text-base mb-1 group-hover:text-primary transition-colors">
                ...
                <button
                  onClick={() => { setDocumentType("org-structure"); setView("setup"); }}
                  className="border border-border rounded-lg p-5 hover:bg-secondary transition-colors group text-left"
                >
                  <p className="font-display font-bold text-base mb-1 group-hover:text-primary transition-colors">
                ...
                <button
                  onClick={() => { setDocumentType("performance-tracking"); setView("setup"); }}
                  className="border border-border rounded-lg p-5 hover:bg-secondary transition-colors group text-left"
                >
                  <p className="font-display font-bold text-base mb-1 group-hover:text-primary transition-colors">
                ...
                <button
                  onClick={() => { setDocumentType("business-health"); setView("setup"); }}
                  className="border border-border rounded-lg p-5 hover:bg-secondary transition-colors group text-left"
                >
                  <p className="font-display font-bold text-base mb-1 group-hover:text-primary transition-colors">
